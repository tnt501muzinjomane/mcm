<?php session_start();
	...
	//Create query
	$qry="SELECT * FROM suggestion order by refNumber DESC";
...
<div id="main">
<!-- header begins -->
<div id="logo"><h1><font color="#FFFFFF">Municipal Council of Mbabane Suggestion System</h1><br /><small>"The City of Mbabane will be the prefered destination in Southern Africa offering quality life"</small>
</div>
<div id="header">
...
<center><div id="content_bg">
  ...
  while ($member = mysql_fetch_array ($result)) {
		...
		echo " <form> <table  border='2' >
				...
				<tr><td width='700'><h2>Suggestion Details</h2></td></tr>
		     <tr><td width='120'><font color='#FFFFFF'>Ref No :{$member['refNumber']}</td></tr>
			  <tr><td width='120'><font color='#FFFFFF'>Name :{$member['name']}</td></tr>
			   <tr><td width='120'><font color='#FFFFFF'>Surname :{$member['surname']}</td></tr>
				...
				<tr><td width='120'><font color='#FFFFFF'>Suggestion Details :{$member['suggestion']}</td></tr>
