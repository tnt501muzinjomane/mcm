<?php
	...
	//Create query
	$qry="SELECT * FROM comp where refNum ='$refNum'";
	$qry2="UPDATE Comp set checked='CHECKED' WHERE refNum='".$refNum."' ";
...
<script type="text/javascript" src="js/jquery-1.4.3.min.js"></script>
	...
	<div id="buttons">
		<ul>
            ...
            <li><a href="mcmchatroom.php" title="">Blog</a></li>
...
<div id="content_bg">
  ...
  <table width="600"  border="0" align="left" cellpadding="#" cellspacing="0" >
    <tr>
     <td><a href="compdetails.php"> <h2>BACK</h2> </a>
     <?php 
