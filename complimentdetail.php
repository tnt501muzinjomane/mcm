<?php session_start();
	...
	//Create query
	$qry="SELECT * FROM compliment order by refNumb DESC";
...
<center><div id="content_bg">
  ...
  while ($member = mysql_fetch_array ($result)) {
		...
		echo " <form> <table  border='2' >
				...
				<tr><td width='700'><h2>Compliment Details</h2></td></tr>
		     <tr><td width='120'><font color='#FFFFFF'>Ref No :{$member['refNumb']}</td></tr>
			  <tr><td width='120'><font color='#FFFFFF'>Name :{$member['name']}</td></tr>
			   <tr><td width='120'><font color='#FFFFFF'>Surname :{$member['surname']}</td></tr>
				...
				<tr><td width='120'><font color='#FFFFFF'>Compliment Details :{$member['compliment']}</td></tr>
