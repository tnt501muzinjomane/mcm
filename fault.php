...
<div id="main">
<!-- header begins -->
<div id="logo"><h1><font color="#FFFFFF">Municipal Council of Mbabane Faults/Maintanance Reporting System</h1><br /><small>"The City of Mbabane will be the prefered destination in Southern Africa offering quality life"</small>
</div>
<div id="header">
	...
	<div id="right"><table width="240" bgcolor="#e77a19" border="2" ><tr><td>
		<h2>Reach the World Below</h2>
			<ul>
          	...
          	<div id="left">
			<h1>Please Report Faults Related with the Council below</h1>
		<div id="text">
		<img src="image/17006.png" alt="" title="" style="padding-right:15px; float:left; padding-left:5px;" width="130" height="140" /><fieldset>
        <h3>What is a fault?</h3><br /><p>It can be anything that cause danger to human beings, infrastructure, environment etc</p><br /><br /><h2>Fill fault details here</h2>
         <?php
	if( isset($_SESSION['ERRMSG_ARR2']) && is_array($_SESSION['ERRMSG_ARR2']) && count($_SESSION['ERRMSG_ARR2']) >0 ) {
		echo '<ul class="err">';
...
$(document).ready(function(){
  $("#form8").validate();
            ...
            <form id="form8" name="form8" method="post" action="faultregister.php"><fieldset spellcheck="true">
  <table width="500" bordercolor="#FF0000" align="left" cellpadding="1" cellspacing="0" style="color: #FFF">
    <tr>
     <td>
				   <tr><td width="200">  <label for="name" id="name">Name:</label></td>
				     
				     <td width="200"><input name="name" type="text" class="required" id="name" maxlength="200" width="280"/></td></tr>
			
             <tr>
     <td>
				   <tr><td width="200">  <label for="surname" id="surname">Surname:</label></td>
				     
				     <td width="200"><input name="surname" type="text" class="required" id="surname" maxlength="200" width="280"/></td></tr>        
				  <tr><td width="200"> 
				     <label for="physicalad" id="physicalad">Physical Address:</label></td><td>
				     <input type="text" name="physicalad" id="physicalad" class="required"/>
				   </td></tr>
				   <tr><td width="200">
                    ...
                    <tr><td width="200">
				     <label for="emailm" id="emailm">Email:</label></td><td>
				     
				     <input type="text" name="emailm" id="emailm" class="required email"/>
				   </td></tr>
                    <tr><td width="200">
				     <label for="area" id="area">Where is the fault?:</label></td><td><textarea name="area" class="required" id="area"></textarea>
			        </td></tr>
				   <tr><td>
				     <label for="fault" id="fault">Fault details:</label></td><td><textarea name="fault" class="required" id="fault"></textarea>
        </td></tr>
				   
				  <tr><td> 
				     <label for="#" id="age">&nbsp;    </label></td><td>
				     <input type="submit" name="bperson" id="bperson" value="Submit"></td></tr>
				   </td>
    </tr>
    </table>
</form>
		  ...
		  <td><a href="admin.php"><img src="image/17008.png" /></a></td>
		</tr>
