<?php session_start();
	...
	//Create query
	$qry="SELECT * FROM fault order by refNo DESC";
...
<div id="main">
<!-- header begins -->
<div id="logo"><h1><font color="#FFFFFF">Municipal Council of Mbabane Fault/Maintanance System</h1><br /><small>"The City of Mbabane will be the prefered destination in Southern Africa offering quality life"</small>
</div>
<div id="header">
...
<center><div id="content_bg">
  <div id="content">
          	...
          	<div id="left">
			<h1>PUBLIC FAULT/MAINTANANCE AREA</h1>
		<div id="text">
		<hr />
        <p>     
     <fieldset>       
  ...
  while ($member = mysql_fetch_array ($result)) {
		...
		echo " <form> <table  border='2' >
				...
				<tr><td width='700'><h2>Fault Details</h2></td></tr>
		     <tr><td width='120'><font color='#FFFFFF'>Ref No :{$member['refNo']}</td></tr>
			  <tr><td width='120'><font color='#FFFFFF'>Name :{$member['name']}</td></tr>
			   <tr><td width='120'><font color='#FFFFFF'>Surname :{$member['surname']}</td></tr>
			    <tr><td width='120'><font color='#FFFFFF'>Physical Ad :{$member['physicaladdress']}</td></tr>
				...
				<tr><td width='120'><font color='#FFFFFF'>Where :{$member['whereFault']}</td></tr>
				<tr><td width='120'><font color='#FFFFFF'>Fault Details :{$member['faultD']}</td></tr>
				<tr><td width='120'><font color='#FFFFFF'>Date :{$member['dateRaised']}</td></tr>
		        <hr>
			</table> </form>";
          }
		  ?>
