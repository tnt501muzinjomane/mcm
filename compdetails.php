<?php session_start();
	...
	//Create query
	$qry="SELECT * FROM comp order by refNum DESC";
...
<div id="main">
<!-- header begins -->
<div id="logo"><h1><font color="#FFFFFF">Municipal Council of Mbabane Complaint System</h1><br /><small>"The City of Mbabane will be the prefered destination in Southern Africa offering quality life"</small>
</div>
<div id="header">
...
<center><div id="content_bg">
  <div id="content">
          	...
          	<div id="left">
			<h1>Municipal Council of Mbabane Complaint  Workplace</h1>
		<div id="text">
		<hr />
        <p>     
     <fieldset>       
  <table width="600"  border="0" align="left" cellpadding="#" cellspacing="0" >
    <tr>
     <td><tr><td><a href='complaint.php'><h2>Reported More Than Once Complaints</h2></a></td><td><a href='complaint1.php'><h2>Reported Once Complaint</h2></a></td></tr>
     <?php 
  ...
  while ($member = mysql_fetch_array ($result)) {
		...
		echo "  <table  border='2' >
				...
				<tr><td width='700'><h2>The Complaint Details</h2></td></tr>
		     <form action='indComp.php'  method='post'><tr><td width='120'><font color='#FFFFFF'>Ref No :<input type='text' STYLE='background-color: #0F412f; border-color: #0F412f; border: 0; font-color: #FFFFFF;' name='refNum' id='refNum' value ='{$member['refNum']}' readonly bgcolor='green'/></td></tr>
			 
			  <tr><td width='120'><font color='#FFFFFF'>Status :{$member['reported']}</td></tr>
			   <tr><td width='120'><font color='#FFFFFF'>Email :{$member['emaila']}</td></tr>
			    <tr><td width='120'><font color='#FFFFFF'>Complaint Details :{$member['compDetail']}</td></tr>
				<tr><td width='120'><font color='#FFFFFF'>Date raised:{$member['dateRaised']}</td></tr>
		        <tr><td width='120'><font color='#F7877'>Status :{$member['checked']}</td><td><input type='submit' name='Submit' value='View details' /></td></tr></form>
			</table> ";
          }
		  ?>
