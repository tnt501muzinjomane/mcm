...
<div id="main">
<!-- header begins -->
<div id="logo"><h1><font color="#FFFFFF">Municipal Council of Mbabane Public Suggestion System</h1><br /><small>"The City of Mbabane will be the prefered destination in Southern Africa offering quality life"</small>
</div>
<div id="header">

    <div id="slider-wrapper">        
            <div id="slider" class="nivoSlider">
                <img src="image/17001.jpg" alt="" />
                <img src="image/17003.jpg" alt=""/>
                <img src="image/17004.jpg" alt="" />
				<img src="image/17005.jpg" alt="" />
            </div>        
  </div>
	...
	<div id="right"><table width="240" bgcolor="#e77a19" border="2" ><tr><td>
		<h2>Reach the World Below</h2>
			<ul>
          	...
          	<div id="left">
			<h1>Please feed your Suggestions below</h1>
		<div id="text">
		<img src="image/17006.png" alt="" title="" style="padding-right:15px; float:left; padding-left:5px;" width="130" height="140" /><fieldset>
        <h3>What is a suggestion?</h3><br /><p><ol ice:repeatinggroup="*">
        <li>It is something that will help to improve the city of Mbbabane
        <li>Your suggestion can be about roads, traffic lights, health, environment, risk, quality, services etc
        </ol></p><br /><h2>Fill your Suggestion here</h2><br />
         <?php
...
$(document).ready(function(){
  $("#form6").validate();
            ...
            <form id="form6" name="form6" method="post" action="suggregister.php"><fieldset spellcheck="true">
    ...
    <tr>
     <td>
				  ...
				  <tr><td width="200"> 
				   ...
				   <tr><td>
				     <label for="sugd" id="sugd">Suggestion details:</label></td><td><textarea name="sugd" class="required" id="sugd"></textarea>
        </td></tr>
				   
				  <tr><td> 
				     <label for="age" id="age">&nbsp;    </label></td><td>
				     <input type="submit" name="bperson" id="bperson" value="Submit suggestion"></td></tr>
				   </td>
    </tr>
    </table></fieldset>
</form>
