	...
	<div id="right"><table width="240" bgcolor="#e77a19" border="2" ><tr><td>
		<h2>Reach the World Below</h2>
			<ul>
          	...
          	<div id="left">
			<h1>Please feed your Complaints below</h1>
		<div id="text">
		<img src="image/17006.png" alt="" title="" style="padding-right:15px; float:left; padding-left:5px;" width="130" height="140" /><fieldset>
        <h3>Definition of a Complaint </h3><br />
        <p>Is an expression of grievance or resentment! An example can a concerned that was reported to the Municipal Council of Mbabane but there were NO actions taken by  responsible officers!</p><br />
        <h2>Fill your Complaint here</h2><br />
...
</script><fieldset spellcheck="true">
              
            <form id="form7" name="form7" method="post" action="compregister.php">
  <table width="400" bordercolor="#FF0000" align="left" cellpadding="1" cellspacing="0" style="color: #FFF">
    <tr>
     <tr><td width="200"> <label for="decesion" id="decesion">Is it your first time to report this concern?<td width="200" ></label>
				    <select name="decesion" id="decesion">
				      <option>NO</option>
				      <option>YES</option>
				  ...
				  <tr><td width="200"> 
				     <label for="physicalA" id="physicalA">Physical Address:</label></td><td>
				     <input type="text" name="physicalA" id="physicalA" class="required"/>
				   </td></tr>
				   <tr><td width="200">
				     <label for="contact" id="contact">Contact<span>*</span>:</label></td><td>
				     
				     <input type="text" name="contact" id="contact" class="required"/>
				   </td></tr>
                   
                   <tr><td width="200">
				     <label for="emaila" id="emaila">Email Address<span>*</span>:</label></td><td>
				     
				     <input type="text" name="emaila" id="emaila" class="required email"/>
				   </td></tr>
                   
				   <tr><td>
				     <label for="comp" id="comp">Complaint Details:</label></td><td><textarea name="comp" class="required" id="comp"></textarea>
        </td></tr>
